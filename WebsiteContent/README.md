...
Dieser Ordner enthält den Index für Website-Inhalte zu einzelnen Bausteinpaketen.
...
Die Website sollte bevorzugt `index.de.json` lesen und anschließend die referenzierten Dateien der einzelnen Bausteinpakete laden.

Bausteinpakete mit Hauptversion 1 oder 2 dürfen nicht in die Website aufgenommen werden. Sie können lokal für historische oder technische Zwecke vorhanden sein, sind aber nicht für die Website-Ausspielung bestimmt.
...
Dadurch kann die Website später die Paketdokumentation lesen, ohne die signierten ZIP-Dateien entpacken zu müssen.
